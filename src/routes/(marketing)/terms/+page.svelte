...
<svelte:head>
  <title>Terms</title>
  <meta name="description" content="Terms and conditions for {WebsiteName}" />
</svelte:head>
...
<div class="prose-lg max-w-screen-sm mx-auto pt-12">
  ...
  <h2>General Terms</h2>
  <p>
    We're not liable for any indirect damages arising from your use or inability
    to use our site. We may change prices and policies at any time and will
    notify you of significant changes through email.
  </p>
  <h3>User Accounts</h3>
  <p>
    For some services, an account is required. Keep your account details
    confidential. Providing false information may lead to account termination.
  </p>
  <p>
    Abusing the platform by creating multiple free accounts may lead to account
    termination.
  </p>
  <h3>Updates to Terms</h3>
  <p>
    We reserve the right to update these terms and conditions, including
    provisions related to commercial use, with notice to users.
  </p>
  ...
  <p>
    Commercial use is granted for images created by accounts subscribed to the
    "Enterprise" plan.
  </p>
  <h3>User Responsibility and Indemnification</h3>
  <p>
    The Company provides tools and resources for users to create coloring pages
    using images.
  </p>
  <p>
  ...
  <p>
    ...
    complies with applicable laws, regulations, and third-party rights.
  </p>
  <p>
    By using the Company's services, users agree to indemnify, defend, and hold
    ...
    fees) arising out of or relating to the user's use of the images, including
    but not limited to any claims of copyright infringement or violation of
  ...
  <p>
    ...
    the user, in which event the user will cooperate with the Company in
