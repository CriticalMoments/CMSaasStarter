...
<div class="navbar bg-base-100">
    ...
    <div class="flex-none">
        <ul class="menu menu-horizontal px-1 hidden sm:flex">
                <li><a href="https://github.com/CriticalMoments/CMSaasStarter" class="bg-base-200">★ us on Github</a></li>
...
<footer class="footer px-10 py-4 border-t border-neutral-600 bg-neutral text-neutral-content">
    <div class="items-center grid-flow-col">
        ...
        <p>ACME Industries Ltd. <br/>Saas templates made easy</p>
    </div> 
